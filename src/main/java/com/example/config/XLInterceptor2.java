...
@Component
@Order(2)
public class XLInterceptor2 implements HandlerInterceptor {
    private String name = "XLInterceptor Order[2] 拦截器";
    private static final NamedThreadLocal<Long> startTimeThreadLocal = new NamedThreadLocal<>("record-time");
    private static final Logger logger = LoggerFactory.getLogger(XLInterceptor2.class);
    /**
     * 预处理回调方法，实现处理器的预处理
